class Talker
    ...
    def byes_mthd
      byes = ["thanks", "thank you", "bye"]
    end
  
    def salutations_mthd
      salutations = ["hey", "hello", "hi", "howdy"]
    end
  
    def multi_salutations_mthd
      multi_salutations = ["how are you", "how is it going", "good morning"]
    end
  
    def purpose_quiz_mthd
      purpose_quiz = [ "what do you do", "who made you", "what can you do"]
    end
    
    def purpose_ans_mthd
      purpose_ans = ["I'm learning Ruby", "I say random fact about Ruby", "Ruby"]
    end
  end
